...
int main (int argc, char **argv)
{
 ...
 {31,32,33,63,64,65,95,96,97,127,128,129,159,160,
  161,191,192,193,223,224,225,255,256,257,287,288,
  289,319,320,321,351,352,353,383,384,385,415,416,
  417,447,448,449,479,480,481,511,512,513,543,544,
  545,575,576,577,607,608,609,639,640,641,671,672,673,
  703,704,705,735,736,737,767,768,769,799,800,801,831,832,833,
  863,864,865,895,896,897,927,928,929,959,960,961,991,992,993,1023,1024,1025};
...
//  for (int L2_sz = 256; L2_sz < 512; L2_sz += 32) {
//    for (int L1_sz = 16; L1_sz < 64; L1_sz += 4) {
//      printf("L2 B: %d\tL1 B: %d\n", L2_sz, L1_sz);
...
//          square_dgemm(n, A, B, C, L2_sz, L1_sz);

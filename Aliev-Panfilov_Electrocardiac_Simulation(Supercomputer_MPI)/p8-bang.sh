...
mpirun -np 1 ./apf-ref/apf -n 400 -i 2000 -x 1 -y 1
mpirun -np 2 ./apf-ref/apf -n 400 -i 2000 -x 1 -y 2
mpirun -np 4 ./apf-ref/apf -n 400 -i 2000 -x 1 -y 4
mpirun -np 8 ./apf-ref/apf -n 400 -i 2000 -x 1 -y 8

echo ">>> REF_NO_COMM"

mpirun -np 1 ./apf-ref/apf -n 400 -i 2000 -x 1 -y 1 -k
mpirun -np 2 ./apf-ref/apf -n 400 -i 2000 -x 1 -y 2 -k
mpirun -np 4 ./apf-ref/apf -n 400 -i 2000 -x 1 -y 4 -k
mpirun -np 8 ./apf-ref/apf -n 400 -i 2000 -x 1 -y 8 -k
